...
def home():
    ...
    <div class='header'><h1>🏓 SportIA Pro V4</h1><p>BOT ACTIVO ✅</p></div>
    <div class='card'><h2>Harimoto vs Fan Zhendong</h2><p style='color:#00ff88'>🤖 IA: 45% VALUE +12%</p></div>
    <div class='card'><h2>Sun Yingsha vs Wang Manyu</h2><p style='color:#00ff88'>🤖 IA: 64% VALUE +18%</p></div>
    <a class='btn' href='/test-bot'>🚨 PROBAR BOT TELEGRAM AHORA</a>
    <p style='text-align:center;color:#666'>@sportia_pro_v3_bot</p>
    </body></html>"""

@app.get("/test-bot")
def test_bot():
    msg = "🚨 SPORTIA PRO V4 - FUNCIONA FERNANDO 🔥\n\nTu bot de apuestas ya esta activo!\nApp: https://web-production-a8499.up.railway.app"
